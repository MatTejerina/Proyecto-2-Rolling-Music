...
function cargarInfo(e) {
  ...
  if (e.target.classList.contains("playLista")) {
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/fondolista.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/cumbia.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/electronica.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/pop.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/reggaeton.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/reggea.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/cuarteto.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/rkt.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/rap.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url(../img/rock.webp)";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url('https://elements-video-cover-images-0.imgix.net/files/9abe091d-e6f4-4bc7-b258-73ee7a5e7ce6/inline_image_preview.jpg?auto=compress&h=630&w=1200&fit=crop&crop=edges&fm=jpeg&s=b7f34213ec3967698e370cd52b903265')";
    ...
    album.style.background =
      "linear-gradient(to right, rgba(2, 2, 2, 0.726) 15%, rgba(8, 8, 8, 0.829)), url('https://i.ytimg.com/vi/yaxcMQIgzhw/maxresdefault.jpg?sqp=-oaymwEmCIAKENAF8quKqQMa8AEB-AH-CYAC0AWKAgwIABABGCYgRSh_MA8=&rs=AOn4CLAWjnqULIQCPtWtbEdL39IKlVmUyA')";
  }
...
function cargarMusica(url) {
  fetch(url)
    ...
    .catch((error) =>
      console.error("Error al cargar la lista de música:", error)
    );
}
...
function controlar(e) {
  ...
  if (e.target.parentElement.classList.contains("siguiente")) {
    let index = musicArray.findIndex(
      (item) => item.querySelector('input[type="text"]').value === audioUrl
    );
    if (index !== -1 && index < musicArray.length - 1) {
      let siguienteMusica =
        musicArray[index + 1].querySelector('input[type="text"]').value;
      let elementoParaReproducido =
        musicArray[index + 1].querySelector(".btn.play-music");
